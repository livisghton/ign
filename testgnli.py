...
def showGraphicSnr(result_snrNli, result_snr, result_numSpan):
    ...
    fig, ax = plt.subplots()
    ax.set(xlabel='Número de span', ylabel='SNR', title='relação sinal ruído por número de span')
...
def showGraphicOsnr(result_osnrNli, result_osnr, result_numSpan):
    ...
    fig, ax = plt.subplots()
    ax.set(xlabel='Número de span', ylabel='OSNR', title='relação sinal ruído óptico por número de span')
